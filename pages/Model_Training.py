...
# Check prerequisites
if not check_page_prerequisites(5):
...
st.markdown("This page loads the best model and evaluates its performance on the dataset.")
...
try:
    ...
    # Prepare test data
    st.subheader("Preparing Test Data")
